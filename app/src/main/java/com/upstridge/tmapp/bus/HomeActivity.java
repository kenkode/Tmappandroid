    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(date_txt.equals("")){
                    Toast.makeText(HomeActivity.this,"Please select travel date",Toast.LENGTH_SHORT).show();
                }else if(time_txt.equals("")){
                    Toast.makeText(HomeActivity.this,"Please select travel time",Toast.LENGTH_SHORT).show();
                }else {
    ...
    public void getRoutes(final Spinner from, final Spinner to, final LinearLayout errorLinear, final ProgressBar loadPrice) {
        ...
        retroRoutes.enqueue(new Callback<List<Route>>() {
            ...
            public void onResponse(Call<List<Route>> call, Response<List<Route>> response) {
                ...
                ArrayAdapter adapter = new ArrayAdapter(HomeActivity.this, android.R.layout.simple_list_item_1, rLocations);
                // apply the Adapter:
