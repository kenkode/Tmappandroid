...
public class AirlineBooking extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(firstclassapply.equals("1")){
            faretypes=new String[]{"Vip Fare : KES "+vip,"Business Fare : KES "+business,"Economic Fare : KES "+economic,"Children Fare : KES "+children};
        }else{
        ...
        ArrayAdapter<String> fareArray= new ArrayAdapter<String>(AirlineBooking.this,android.R.layout.simple_spinner_item, faretypes);
        ...
        ArrayAdapter<String> seatArray= new ArrayAdapter<String>(AirlineBooking.this,android.R.layout.simple_spinner_item, seats);
        ...
        ArrayAdapter<String> modeArray= new ArrayAdapter<String>(AirlineBooking.this,android.R.layout.simple_spinner_item, modes);
